...
componentname="numCandidatesMap"
...
filters = "filterid,construction,isinit
           1,selectInput(ns(\"numcandI_year\"):\"Select Year\": c() : selectize = TRUE),T
           2,checkboxGroupInput(ns(\"numcand_names\") : \"Select number of candidates \": c()),F"
    
inputtable="filterid,name,type,alias
            1,statename_reactive(),string,selected_stname 
            2,input$numcandI_year,string,selected_year
            3,input$numcandI_year,string,selected_year
            3,input$numcand_names,list,selected_numbers"

##default can be allmultiple/allsingle/emptymultiple/emptysingle/NA.
outputtable="filterid,name,type,alias,default,label 
            1,numcandI_year, updateSelectInput,yearlist,emptysingle,\"Select Year\"
            2,numcand_names, updateCheckboxGroupInput,numoptions,allmultiple,\"Select number of candidates\"
...
functiontable="filterid,funname
              ...
              2,getOptions(state=\"selected_stname\" : year=\"selected_year\": options=\"numoptions\" : currentvalues)
              3,plotMap(state=\"selected_stname\" : year=\"selected_year\": options=\"numoptions\" : plot=\"leafletmap\" : currentvalues)"
##########################################################################

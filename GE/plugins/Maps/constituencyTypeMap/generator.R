...
componentname="constituencyTypeMap"
...
filters = "filterid,construction,isinit
           ...
           2,checkboxGroupInput(ns(\"filter_pname\") : \"Select constituency type \": c()),F"
    
inputtable="filterid,name,type,alias
            1,NA,NA,NA 
            2,input$I_year,string,selected_year
            3,input$I_year,string,selected_year
            3,input$filter_pname,list,selected_options"
...
outputtable="filterid,name,type,alias,default,label 
            ...
            2,filter_pname, updateCheckboxGroupInput,options,allmultiple,\"Select constituency type\"

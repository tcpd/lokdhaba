...
outputtable="filterid,name,type,alias,default,label 
            ...
            2,filter_pnames, updateCheckboxGroupInput,notaoptions,allmultiple,\"Select range\"
